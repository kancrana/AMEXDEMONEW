...
namespace eShop.Web.Services
{
    public class ProductListingService : HttpClientBase, IProductListingService
    {
        ...
        {
            var response = new HttpRequestBuilder(_appSettings.ApiBaseUrl)
                 .SetPath("<CustomAPICallPath>")
        ...
        {
            var response = new HttpRequestBuilder(_appSettings.ApiBaseUrl)
                 .SetPath("api/ProductCatalog/items")
                 .HttpMethod(HttpMethod.Get)
                 .GetHttpMessage();
        ...
        {
            var response = new HttpRequestBuilder(_appSettings.ApiBaseUrl)
                 .SetPath("api/ProductCatalog/productBrands")
                 .HttpMethod(HttpMethod.Get)
                 .GetHttpMessage();
        ...
        {
            var response = new HttpRequestBuilder(_appSettings.ApiBaseUrl)
                 .SetPath("api/ProductCatalog/productTypes")
                 .HttpMethod(HttpMethod.Get)
                 .GetHttpMessage();
        ...
        {
            var response = new HttpRequestBuilder(_appSettings.ApiBaseUrl)
                 .SetPath("api/ProductCatalog/items/" + Id)
                 .HttpMethod(HttpMethod.Get)
                 .GetHttpMessage();
